...
const makeHistoryProject = (index: number): IndustryProject => ({
    ...
    streamingWindows: [{
        ...
        performance: {
            openingWeekAbsoluteWeek: projectRetentionWeek - 20,
            latestProcessedAbsoluteWeek: projectRetentionWeek - 10,
            cumulativeViewingHoursMillions: 1,
            cumulativeCompletionStartsMillions: 1,
            cumulativeNewSubscribersMillions: 0,
            cumulativeChurnSavedMillions: 0,
            cumulativeRevenueMillions: 1,
            cumulativeVariableCostMillions: 0.1,
        },
    }],
});
