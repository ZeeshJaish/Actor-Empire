...
assert(OWNED_STREAMING_PLATFORM_SCHEMA_VERSION === 26, 'The canonical foundation should preserve public markets in schema v25.');
const migrated = normalizeOwnedStreamingPlatformState({ schemaVersion: 19 }, 'phase22-migration');
assert(migrated.schemaVersion === 26 && migrated.publicCompany.lifecycle === 'PRIVATE', 'Schema v19 saves should migrate to a safe private-company state.');
