...
assert(OWNED_STREAMING_PLATFORM_SCHEMA_VERSION === 27, 'The canonical foundation should preserve public markets in schema v27.');
const migrated = normalizeOwnedStreamingPlatformState({ schemaVersion: 19 }, 'phase22-migration');
assert(migrated.schemaVersion === 27 && migrated.publicCompany.lifecycle === 'PRIVATE', 'Schema v19 saves should migrate to a safe private-company state.');
