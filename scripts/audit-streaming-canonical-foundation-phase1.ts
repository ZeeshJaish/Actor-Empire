...
assert(OWNED_STREAMING_PLATFORM_SCHEMA_VERSION === 27, 'Phase 1 must retain pending infrastructure revisions in the canonical schema.');
assert(normalized.schemaVersion === 27, 'Legacy saves must normalize to the current canonical schema.');
