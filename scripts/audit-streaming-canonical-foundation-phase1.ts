...
assert(OWNED_STREAMING_PLATFORM_SCHEMA_VERSION === 26, 'Phase 1 must advance the canonical streaming save schema to v24.');
assert(normalized.schemaVersion === 26, 'Legacy saves must normalize to the current canonical schema.');
