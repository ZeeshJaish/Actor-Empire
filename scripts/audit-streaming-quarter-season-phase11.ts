...
assert(OWNED_STREAMING_PLATFORM_SCHEMA_VERSION === 25, 'The canonical foundation should advance owned-streaming schema to v24.');
assert(migrated.schemaVersion === 25 && migrated.cycleReviews.length === 0, 'Older saves should migrate with a safe empty cycle-review history.');
