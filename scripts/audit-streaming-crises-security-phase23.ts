...
assert(OWNED_STREAMING_PLATFORM_SCHEMA_VERSION === 27, 'The canonical foundation should own streaming schema v27.');
const migrated = normalizeOwnedStreamingPlatformState({ schemaVersion: 20 }, 'phase23-migration');
assert(migrated.schemaVersion === 27, 'Schema v20 saves should migrate to the current schema.');
assert(
