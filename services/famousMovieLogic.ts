...
export const FAMOUS_MOVIE_DB: FamousProjectDef[] = [
    ...
    { title: "Knives Out", genre: "MYSTERY", director: "Rian Johnson", difficulty: 78, studioId: "ARTISAN_PICTURES", prestige: 88, description: "A modern whodunit where every suspect has a motive.", type: 'MOVIE' },
    { title: "Gone Girl", genre: "MYSTERY", director: "David Fincher", difficulty: 86, studioId: "ARTISAN_PICTURES", prestige: 90, description: "A disappearance turns marriage, media, and truth into a weapon.", type: 'MOVIE' },
...
export const FAMOUS_SERIES_DB: FamousProjectDef[] = [
    ...
    { title: "Sherlock", genre: "MYSTERY", director: "Steven Moffat", difficulty: 82, studioId: "HBO", prestige: 88, description: "A modern detective genius turns impossible cases into public spectacle.", type: 'SERIES' },
    { title: "Only Murders in the Building", genre: "MYSTERY", director: "John Hoffman", difficulty: 74, studioId: "HULU", prestige: 84, description: "Neighbors turn true-crime obsession into a dangerous amateur investigation.", type: 'SERIES' },
